...
class PatientService:
    ...
    - Dùng selectinload khi cần lấy relationship để tránh lỗi lazy='raise'.
    """
    ...
    def get_by_id(self, patient_id: UUID) -> Patient | None:
        ...
        Dùng cho:
        - Xem chi tiết hồ sơ.
        - Tạo prediction cho bệnh nhân.
        """

        statement = select(Patient).where(Patient.id == patient_id)
        return self.db.scalar(statement)

    def get_detail_by_id(self, patient_id: UUID) -> Patient | None:
        """
        Lấy chi tiết bệnh nhân kèm thông tin người tạo.

        Vì model relationship dùng lazy='raise',
        ta phải chủ động selectinload relationship cần dùng.
        """
    ...
    def list_patients(
        ...
        *,
        ...
        created_by dùng khi muốn lọc bệnh nhân do một bác sĩ tạo.
        """
